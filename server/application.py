...
app = Flask(__name__) 
CORS(app, origins=["*"])  # This already handles CORS headers, so no need for the @app.after_request function
...
DB_HOST='messaging-db.cfwoq22sszs8.eu-west-2.rds.amazonaws.com'
DB_USER='admin'
DB_PASSWORD='msg-app-db'
DB_NAME='msg_db'
DB_SSL_PATH='/home/ec2-user/eu-west-2-bundle.pem'
...
context.load_cert_chain(certfile='/home/ec2-user/certificate.pem', keyfile='/home/ec2-user/private.key')
